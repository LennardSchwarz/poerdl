								...
								<div className="text-center">
									...
									<div className="mt-2">
										<p className="text-sm text-gray-500">
											Du hast 6 Versuche, das Wort des
										...
										<p className="text-sm text-gray-500">
											Der <b>grüne</b> Buchstabe D kommt
											im Wort an der richtigen Stelle vor.
										</p>
										...
										<p className="text-sm text-gray-500">
											Der <b>gelbe</b> Buchstabe A kommt
											im Wort vor, jedoch an anderer
											Stelle.
										</p>
